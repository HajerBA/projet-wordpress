...
<!-- start column2nd -->
	...
	<?php if (is_category()) { ?>
				<h3 class="result-heading"><?php _e('Posts tagged as',photographythemes); ?> &lsquo;<?php echo single_cat_title(); ?>&rsquo;</h3>        
			<?php } elseif (is_day()) { ?>
				<h3 class="result-heading"><?php _e('Archive',photographythemes); ?> | <?php the_time('F jS, Y'); ?></h3>
			<?php } elseif (is_month()) { ?>
